...
BUCKET_TO_DEL = 'nba-playoffs-daily-stats-staging-bucket'
DATABASE_TO_DEL = 'nba-playoffs-proj-db'
TABLE_TO_DEL = 'staging_nba_playoffs_daily_data_parquet_tbl'
QUERY_OUTPUT_BUCKET = 's3://query-results-location-nba-playoffs-proj/'
