...
SOURCE_TABLE_NAME = 'nba_crawler_nba_playoffs_historical_bucket'
NEW_TABLE_NAME = 'final_nba_playoffs_data_parquet_tbl_prod'
NEW_TABLE_S3_BUCKET = 's3://nba-playoffs-parquet-table-prod/'
...
queryStart = client.start_query_execution(
    ...
    WHERE "team.conference" IN ('West', 'East')
    ;
    """,
